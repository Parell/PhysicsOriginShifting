...
{
    // Helper for barrel recoil animation.
    public class Barrel
    {
    ...
    // Spawns projectiles, manages muzzle flash, and feeds shot timing to the weapon system.
    public class Gun : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            // Default to the gun's own transform if no explicit fire point is configured.
        ...
        private void FixedUpdate()
        {
            ...
            {
                // Keep firing and recoil animation in sync with the active simulation speed.
                if (isFiring)
                {
        ...
        private bool AttemptFireShot(Vector3 inheritedVelocity)
        {
            ...
            // Sequential mode advances one muzzle per shot; otherwise all muzzles fire together.
        ...
        {
            // Bullets are pooled, registered with the physics manager, then launched from the muzzle.
