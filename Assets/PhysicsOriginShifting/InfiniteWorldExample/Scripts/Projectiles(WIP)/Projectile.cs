...
{
    // Tracks projectile flight, collision checks, and destruction effects.
    public class Projectile : MonoBehaviour
    {
        ...
        public void Reset()
        {
            // Clear per-shot collision filters when the projectile is returned from the pool.
        ...
        {
            // Launch direction is randomized slightly so repeated shots are not perfectly identical.
        ...
        public void DestroyFromCollision(Vector3 impactedPosition, Quaternion impactRotation)
        {
            ...
            {
                // Impact and explosion effects are also pooled bodies so they participate in the same scene rules.
        ...
        private void UpdateProjectile(float deltaTime)
        {
            ...
            else
            {
                ...
                if (hitSomething)
                {
                    // Bounce only on shallow impacts; otherwise the projectile is destroyed on contact.
        ...
        {
            // Damage and force application were intentionally left as hooks for game-specific systems.
        }
        ...
        {
            // Thick projectiles use a sphere cast to better match their visual diameter.
