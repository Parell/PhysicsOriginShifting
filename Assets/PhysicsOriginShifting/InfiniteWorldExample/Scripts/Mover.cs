...
{
    // Converts desired translation and attitude into per-thruster throttle values.
    public class Mover : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            // Thruster metadata is cached once so control allocation can stay cheap per frame.
        ...
        {
            // Aggregate per-axis limits from all non-main thrusters.
        ...
        private void FixedUpdate()
        {
            ...
            // Solve attitude and translation separately, then allocate them to the available thrusters.
        ...
        {
            // Convert a desired angular acceleration into a bounded world-space torque.
        ...
        // Missile guidance used by AI or weapon systems.
        ...
        // Generic AI steering helper that prioritizes facing and forward acceleration.
        ...
        {
            // Greedy one-thruster-at-a-time allocator that reduces force and torque residuals together.
